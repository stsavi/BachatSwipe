...
### 1. SBI Rewardz Portal (Cleartrip)
*   **Multiplier:** 10x on Cleartrip bookings (SimplyCLICK)
*   **Platform:** SBI Rewardz

### 2. Direct Multipliers
*   **SimplyCLICK:** 10x on BookMyShow, Lenskart, Netmeds.
*   **SimplySAVE:** 10x on Dining, Movies, Groceries.

### 3. Special Features
*   **SBI Cashback:** 5% unlimited cashback on ONLINE spends (some exclusions).
*   **BPCL:** 25x rewards on fuel at BPCL stations (~6.25% value).
*   **Vistara Prime:** Free tickets on spend milestones.
